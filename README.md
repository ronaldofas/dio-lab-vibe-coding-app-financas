...
```txt
- Os gastos devem ser atualizados automaticamente após a resposta da iteração do usuário, quando for necessário.
- É necessário ter a possibilidade de informar recebimento também
